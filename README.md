...
<picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://banners.beyondco.de/Github%20Preview%20Updater.png?theme=dark&pattern=topography&style=style_2&fontSize=100px&images=photograph&packageManager=npm+install&packageName=preview-updater&description=Lightweight+preview+update+in+your+repository&md=1&showWatermark=1">
    <img src="https://banners.beyondco.de/Github%20Preview%20Updater.png?theme=light&pattern=topography&style=style_2&fontSize=100px&images=photograph&packageManager=npm+install&packageName=preview-updater&description=Lightweight+preview+update+in+your+repository&md=1&showWatermark=1" alt="Github Preview Updater">
</picture>
